 ...
 */
export type ExtensionGPLExtended = 'ac3' | 'adx' | 'aif' | 'aiff' | 'afc' | 'aifc' | 'al' | 'amr' | 'apng' | 'aptx' | 'aptxhd' | 'asf' | 'wmv' | 'wma' | 'ass' | 'ssa' | 'ast' | 'au' | 'avi' | 'avs' | 'avs2' | 'bit' | 'caf' | 'cavs' | 'c2' | '302' | 'drc' | 'vc2' | 'dnxhd' | 'dnxhr' | 'dts' | 'dv' | 'eac3' | 'ffmeta' | 'cpk' | 'flm' | 'fits' | 'flac' | 'flv' | 'g722' | 'tco' | 'rco' | 'gif' | 'gsm' | 'gxf' | 'h261' | 'h263' | 'h264' | '264' | 'hevc' | 'h265' | '265' | 'm3u8' | 'lbc' | 'ivf' | 'vag' | 'm4v' | 'sub' | 'mjpg' | 'mjpeg' | 'mlp' | 'mmf' | 'mp3' | 'mp4' | 'mpg' | 'mpeg' | 'mkv' | 'mov' | 'ts' | 'm2t' | 'm2ts' | 'mts' | 'ul' | 'mxf' | 'nut' | 'ogg' | 'oma' | 'yuv' | 'rgb' | 'rm' | 'ra' | 'roq' | 'rso' | 'sw' | 'sb' | 'sbc' | 'msbc' | 'scc' | 'sox' | 'spdif' | 'srt' | 'sup' | 'swf' | 'thd' | 'tta' | 'uw' | 'ub' | 'vc1' | 'rcv' | 'voc' | 'w64' | 'wav' | 'xml' | 'vtt' | 'wtv' | 'wv' | 'y4m';
/**
